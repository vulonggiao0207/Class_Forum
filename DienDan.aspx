<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DienDan.aspx.cs" Inherits="DienDan" %>

<%@ Register Src="User_Control/DienDanUC.ascx" TagName="DienDanUC" TagPrefix="uc2" %>
        ...
        <div id="templatemo_wrapper">
            ...
            <div id="templatemo_header">
                ...
                <div id="templatemo_menu" style="text-align: left">
                    <ul>
                        ...
                        <li><a href="DienDan.aspx">Diễn đàn</a></li>
            ...
            <div id="templatemo_main">
                <div class="content_box" style="text-align: center">
                    <uc2:DienDanUC ID="DienDanUC1" runat="server" />
                    &nbsp;&nbsp;</div>
