<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DangKyThanhCong.aspx.cs" Inherits="DangKyThanhCong" %>

<%@ Register Src="User_Control/DangNhap1.ascx" TagName="DangNhap1" TagPrefix="uc1" %>
                ...
                <div class="content_box" style="text-align: center">
                    &nbsp;&nbsp;<table width="100%">
                        <tr>
                            ...
                            <td style="width: 100px; height: 50px">
                                <asp:Label ID="Label1" runat="server" Height="20px" Text="Đăng ký thành công. Bạn có thể đăng nhập vào hệ thống"
